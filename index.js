...
async function connectToWA() {
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('94774575878', '94783314361', '94773024361');
...
if (senderNumber.includes("94774575878") && !isReact) {
